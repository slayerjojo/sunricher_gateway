...
#define OPCODE_DISCOVER_ENDPOINTS_REPORT "DiscoverEndpointsReport"
#define OPCODE_POWERCONTROLLER_TURNON "TurnOn"
#define OPCODE_POWERCONTROLLER_TURNOFF "TurnOff"
#define OPCODE_BRIGHTNESSCONTROLLER_SETBRIGHTNESS "SetBrightness"
#define OPCODE_COLORCONTROLLER_SETCOLOR "SetColor"
